...
class InstalledController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    @UserDefaultsWrapper(key: "wiki.qaq.saily.installed.sortOption", defaultValue: SortOption.lastModification.rawValue)
    var _sortOption: String
    @UserDefaultsWrapper(key: "wiki.qaq.saily.installed.sortReversed", defaultValue: false)
    ...
    @UserDefaultsWrapper(key: "wiki.qaq.saily.searchWithCaseSensitive", defaultValue: false)
