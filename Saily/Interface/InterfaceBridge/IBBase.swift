...
enum InterfaceBridge {
    @UserDefaultsWrapper(key: "wiki.qaq.saily.collectedPackages", defaultValue: Data())
    ...
    @UserDefaultsWrapper(key: "wiki.qaq.saily.enableShareSheet", defaultValue: false)
    ...
    @UserDefaultsWrapper(key: "wiki.qaq.saily.mainUserAgent", defaultValue: "Saily/2.0 Cydia/1.1.32")
