...
UserDefaults
    .standard
    .setValue("wiki.qaq.saily", forKey: "wiki.qaq.saily.storeDirPrefix")

private let availableDirectories = FileManager
    .default
    .urls(for: .documentDirectory, in: .userDomainMask)
public let documentsDirectory = availableDirectories[0]
    .appendingPathComponent("wiki.qaq.saily")

private let previousSetupLocation = UserDefaults
    .standard
    .string(forKey: "wiki.qaq.saily.setupLocation")
...
UserDefaults
    .standard
    .setValue(documentsDirectory.path, forKey: "wiki.qaq.saily.setupLocation")
